...
export class CommentController {
  ...
  @Public()
  @Post()
  async createComment(@Body() body: CreateCommentDto, @Request() req: any) {
    const ipAddress =
  ...
  @Roles('ADMINISTRATOR', 'SUPER_ADMIN', 'EDITOR')
  @Patch(':id/approve')
  async approveComment(@Param('id') id: string, @Request() req: any) {
  ...
  @Patch(':id/reject')
  async rejectComment(@Param('id') id: string, @Request() req: any) {
  ...
  async bulkReject(@Body() body: { ids: string[] }, @Request() req: any) {
